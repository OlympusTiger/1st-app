...
message.setStyleSheet(
    "font-size:23px; color:white; padding:10px 10px; margin:10px 250px"
)
...
ext.setStyleSheet(
    '*{ border:4px solid "#303030"; border-radius:10px; font-size:17px; color:"grey"; padding:10px 15px; margin:0 10px;}*:hover{background:"#CD0000";color:"grey";}'
)
...
def frame_start():
    ...
    button.setStyleSheet(
        '*{ border:4px solid "#303030"; border-radius:14px; font-size:35px; color:"white"; padding:10px 10px; margin:10px 200px;}*:hover{background:"#CD661D";color:"green";}'
    )
...
def frame_main():
    ...
    prompt.setStyleSheet(
        'border:4px solid "black"; border-radius:14px; font-size:25px; color:white; padding:5px 10px; margin:5px 250px'
    )
    ...
    save.setStyleSheet(
        'border:3px solid "white"; border-radius:5px; font-size:20px; color:white; padding:5px 100px; margin:10px 180px'
    )
...
def frame_save():
    ...
    if globals_["check_ok"] == True:
        ...
        widgets["again"][-1].setStyleSheet(
            'border:3px solid "white"; border-radius:5px; font-size:20px; color:white; padding:5px 10px; margin:10px 420px'
        )
